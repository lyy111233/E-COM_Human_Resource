            ...
            <div class="container">
                <div class="row align-items-lg-center">
                    ...
                    <div class="col-lg-6 order-lg-1 text-center mx-auto">
                        ...
                        <p class="lead mb-5 text-white" data-aos="fade-up" data-aos-delay="100">July 3, 2018 &bullet; by
                            <a href="#" class="text-white">John Smith</a></p>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <p><img src="{{ asset('frontend/images/hero_1.jpg') }}" alt="" class="img-fluid"></p>
                        ...
                        <p>
                            <img src="{{ asset('frontend/images/slider-1.jpg') }}" alt="" class="img-fluid">
                        </p>
                    ...
                    <div class="col-md-4 sidebar">
                        ...
                        <div class="sidebar-box">
                            <img src="{{ asset('frontend/images/person_1.jpg') }}" alt="Image placeholder" class="img-fluid mb-4 rounded">
                            ...
                            <div class="col-md-3">
                                <div class="block-footer-widget">
                                    ...
                                    <ul class="list-unstyled block-social">
                                        ...
                                        <li><a href="#" class="p-1"><span class="icon-github"></span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
